...
const Navbar = ({scrollToTarget,scrollToFooter,scrollToInfo}) => {
  ...
  <div class="container-fluid" >
    <a class="navbar-brand" href="#" style={{fontWeight: 700,fontFamily:'cursive'}}>SSO Demo</a>
    ...
    <div  id="navbarNav" className={`collapse navbar-collapse ${styles.navshift}`}>
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#" style={{fontWeight: 700}} onClick={scrollToTarget}>Features</a>
        </li>
        <li class="nav-item">
